...
#>                 truth        mle        pmle
#> sta_(Intercept)   0.6 -0.1322958  0.02430913
#> sta_x1            0.5  0.1951644  0.25655518
#> det_(Intercept)   0.4  1.7158595  1.17728810
#> det_x1           -0.5 -0.8026997 -0.65455396
#> det_x3            0.3  0.6823315  0.48569845
...
#> sta_(Intercept)      0.06115388  0.05059638     -0.24356447 -0.02790892
#> sta_x1               0.05059638  0.07525104     -0.18873666 -0.12264427
#> det_(Intercept)     -0.24356447 -0.18873666      1.03655393  0.02910523
#> det_x1              -0.02790892 -0.12264427      0.02910523  0.42595948
#> det_x3              -0.10172896 -0.09312255      0.42897952  0.06620207
#>                      det_x3
#> sta_(Intercept) -0.10172896
#> sta_x1          -0.09312255
#> det_(Intercept)  0.42897952
#> det_x1           0.06620207
#> det_x3           0.21295777
vcov(m00, model="sta")
#>             (Intercept)         x1
#> (Intercept)  0.06115388 0.05059638
#> x1           0.05059638 0.07525104
vcov(m00, model="det")
#>             (Intercept)         x1         x3
#> (Intercept)  1.03655393 0.02910523 0.42897952
#> x1           0.02910523 0.42595948 0.06620207
#> x3           0.42897952 0.06620207 0.21295777
## confidence intervals
confint(m00)
#>                       2.5%     97.5%
#> sta_(Intercept) -0.6169814 0.3523897
#> sta_x1          -0.3424914 0.7328202
#> det_(Intercept) -0.2796052 3.7113241
#> det_x1          -2.0818814 0.4764820
#> det_x3          -0.2221399 1.5868029
confint(m00, model="sta")
#>                   2.5%     97.5%
#> (Intercept) -0.6169814 0.3523897
#> x1          -0.3424914 0.7328202
confint(m00, model="det")
#>                   2.5%    97.5%
#> (Intercept) -0.2796052 3.711324
#> x1          -2.0818814 0.476482
#> x3          -0.2221399 1.586803
