## this is just to demonstrate that P is biased, but NB is not
...
set.seed(1234)
library(detect)
source("~/Dropbox/pkg/detect2/mee-rebuttal/rev2/svabu2.fit.R")
...
save.image(paste0("~/Dropbox/pkg/detect2/mee-rebuttal/rev2/svp-check.Rdata"))
