...
It is not totally clear how to best parametrize it and what link function to use.
Both log and inverse link leads to non-finite results for $y=0$.
The point here should be that we condition on the zeroes, so
...
$f(y=0; \theta)$ is also funny analytically, because the exponential term
